...
#pragma warning(disable: 4996) // lorte lort, disabler en warning
...
Image* Image::copyFlip(bool horizontal, bool vertical) const {
    Image* dstImg = new Image(_width,_height,_colorCode,_depth);
